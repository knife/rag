...
-- AddForeignKey
ALTER TABLE "ChatSession" ADD CONSTRAINT "ChatSession_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES "Collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
